...
(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			normal:		{ range: '-1280', href: '/static/css/style-normal.css', containers: 960, lockViewport: true },
			narrow:		{ range: '-980', href: '/static/css/style-narrow.css', containers: '95%', grid: { gutters: 25 } },
			narrower:	{ range: '-840', href: '/static/css/style-narrower.css', grid: { collapse: true } },
